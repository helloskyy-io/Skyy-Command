...
// import { ActiveComponentsService } from '../../services/active-components.service';  // Temporarily comment out if not used

@Component({
  selector: 'app-aside',
  standalone: true,
  imports: [RouterModule], // Simplified to RouterModule only
